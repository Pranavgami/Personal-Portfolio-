...
const Navbar = (props) => {
  ...
  return (
    <div
      style={{
        backgroundColor: ModeInfo.isDark ? "#1C1C1C" : "#f3f3f3",
        boxShadow: ModeInfo.isDark
          ? "0px 2px 10px 1px whitesmoke"
          : "0px 2px 10px 1px rgba(0, 0, 0, 0.5)",
      }}
    ...
    >
      ...
      <div
        style={{
          backgroundColor: ModeInfo.isDark ? "whitesmoke" : "#1c1c1c",
          color: ModeInfo.isDark ? "black" : "white",
        }}
        className={`sidebar ${isSidebar ? "show" : "hide"} `}
      >
        <div
          style={{
            marginTop: "1rem",
        ...
        <div
          ...
          onClick={() => {
            props.scrollToSection(props.aboutmeref);
            handleSidebar();
          }}
        >
          About Me
        ...
        <div
          ...
          onClick={() => {
            props.scrollToSection(props.Skillref);
            handleSidebar();
          }}
        >
          Skills
        ...
        <div
          style={{ fontWeight: "500" }}
          onClick={() => {
            props.scrollToSection(props.contactmeref);
            handleSidebar();
          }}
        >
          Contact Me
      ...
      <div className="n-options top-animate">
        <div onClick={() => props.scrollToSection(props.aboutmeref)}>
          About Me
        </div>
        <div onClick={() => props.scrollToSection(props.Skillref)}>Skills</div>
        <div onClick={() => props.scrollToSection(props.projectsref)}>
          Projects
        </div>
        <div onClick={() => props.scrollToSection(props.contactmeref)}>
          Contact
        </div>
      </div>
      ...
      <div>
        {ModeInfo.isDark ? (
          <button onClick={handleMode} className="mode-logo top-animate">
            <FontAwesomeIcon icon={faSun} style={{ color: "#E8D62D" }} />
          </button>
        ) : (
          <button onClick={handleMode} className="mode-logo top-animate">
        ...
        <button onClick={handleSidebar} className="bar-logo top-animate">
